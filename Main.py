...
main = tkinter.Tk()
main.title("CNN based Bird spiece identification")
...
font = ('Roboto',20,"bold")
title = Label(main, text='CNN Based Bird Spiece Identification')
title.config(bg='#f1f1f1', fg='#DF2935')  
title.config(font=font)           
title.config(height=3, width=80)       
title.place(x=5,y=5)

font1 = ('Roboto', 14)
upload = Button(main, text="Upload Bird Image", command=upload,fg="green")
upload.place(anchor = CENTER,x=580,y=180)
upload.config(font=font1)  

pathlabel = Label(main)
pathlabel.config(bg="#5EB1BF", fg='red')  
pathlabel.config(font=font1)           
pathlabel.place(x=250,y=210)

depthbutton = Button(main, text="Run CNN & View Identified Species",command=DCNN,fg="green")
depthbutton.place(anchor = CENTER,x=610,y=270)
depthbutton.config(font=font1) 


viewresults = Button(main, text="View Score Graph", command=scoreGraph,fg="green")
viewresults.place(anchor = CENTER,x=600,y=340)
viewresults.config(font=font1) 

main.config(bg="#5EB1BF")
main.mainloop()